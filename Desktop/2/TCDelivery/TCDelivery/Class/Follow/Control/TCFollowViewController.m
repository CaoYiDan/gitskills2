...
//            NSString*y=[NSString stringWithFormat:@"%.3f",[di[@"x"] floatValue]];
//            CGFloat longitude=[y floatValue];
//            NSString*x=[NSString stringWithFormat:@"%.3f",[di[@"y"] floatValue]];
//            CGFloat latitude=[x floatValue];
//            
...
//   NSArray*colorArr=@[[UIColor redColor],[UIColor blackColor],[UIColor orangeColor]];
    
    if ([overlay isKindOfClass:[BMKPolyline class]]){
        BMKPolylineView* polylineView = [[BMKPolylineView alloc] initWithOverlay:overlay] ;
//        UIColor *co=colorArr[arc4random()%3];
