...
-(void)createUI{
    ...
    UILabel*addressLabel=[[UILabel alloc]initWithFrame:CGRectMake(0, 0, 70, 30)];
    addressLabel.font=Font(13);
    addressLabel.text=@"所属地区";
    addressLabel.textAlignment=NSTextAlignmentCenter;
    [baseAdderssView addSubview:addressLabel];
    
    UIButton*addressBtn=[[UIButton alloc]initWithFrame:CGRectMake(80, 0, 160, 30)];
...
//    营业执照电子版
    ...
    UILabel*businessLicenceLabel=[[UILabel alloc]initWithFrame:CGRectMake(0, 0, 100, 30)];
    businessLicenceLabel.font=Font(11);
    businessLicenceLabel.text=@"营业执照电子版";
    [photoBaseView1 addSubview:businessLicenceLabel];
    
    UIImageView*businessLicenceImage=[[UIImageView alloc]initWithFrame:CGRectMake(100, 0, 100, 50)];
    ...
    UIButton*choseBtn1=[[UIButton alloc]initWithFrame:CGRectMake(205, 10, 60, 30)];
    ...
    [photoBaseView1 mas_makeConstraints:^(MASConstraintMaker *make){
        make.centerX.offset(0);
        make.size.offset(CGSizeMake(270, 50));
    ...
    UILabel*frontIdentificationCard=[[UILabel alloc]initWithFrame:CGRectMake(0, 0, 100, 30)];
    ...
    UIImageView*frontIdentificationCardImage=[[UIImageView alloc]initWithFrame:CGRectMake(100, 0, 100, 50)];
   ...
   frontIdentificationCardImage.backgroundColor=LGLighgtBGroundColour235;
    ...
    UIButton*choseBtn2=[[UIButton alloc]initWithFrame:CGRectMake(205, 10, 60, 30)];
    ...
    UILabel*oppositeIdentifier=[[UILabel alloc]initWithFrame:CGRectMake(0, 0, 100, 30)];
    ...
    UIImageView*oppositeIdentifierImage=[[UIImageView alloc]initWithFrame:CGRectMake(100, 0, 100, 50)];
    ...
    UIButton*choseBtn3=[[UIButton alloc]initWithFrame:CGRectMake(205, 10, 60, 30)];
...
-(void)addressClick:(UIButton*)btn{
    ...
    TCProvicePickView*basePickView=[[TCProvicePickView alloc]initWithFrame:self.view.bounds complent:^(NSString *provice, NSString *city, NSString *country) {
        [btn setTitle:[NSString stringWithFormat:@"%@ %@ %@",provice,city,country] forState:0];
        weakSelf.province=provice;
        weakSelf.city=city;
        weakSelf.county=country;
    }];
...
- (void)upDateHeadIcon:(UIImage *)photo{
    ...
    [manager POST:@"http://www.tiancheng100y.com/tcwl-image-server/v1/image/upload" parameters:dictT constructingBodyWithBlock:^(id<AFMultipartFormData>  _Nonnull formData) {
