...
-(void)setUpView{
    ...
    //中上的分割线
    UIView*line0=[[UIView alloc]initWithFrame:CGRectMake(0, 42, kWindowW, 1)];
    ...
    _goodsWeight.frame=CGRectMake(20, 100,60,30);
    ...
    //中下的分割线
    UIView*line1=[[UIView alloc]initWithFrame:CGRectMake(0, 135, kWindowW, 1)];
